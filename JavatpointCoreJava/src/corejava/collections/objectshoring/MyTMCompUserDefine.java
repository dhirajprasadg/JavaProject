...
public class MyTMCompUserDefine {
	...
	public static void main(String[] args) {
		...
		// Simple Tree Map short by key natural ordering
		TreeMap<Empl, String> tm0 = new TreeMap<Empl, String>();
		tm0.put(new Empl("Ram", 3000), "RAM");
		tm0.put(new Empl("John", 6000), "JOHN");
		tm0.put(new Empl("Crish", 2000), "CRISH");
		tm0.put(new Empl("Tom", 2400), "TOM");
		Set<Empl> keys0 = tm0.keySet();
		for (Empl key0 : keys0) {
			System.out.println(key0 + " ==> " + tm0.get(key0));
		}
		System.out.println("===================================");
