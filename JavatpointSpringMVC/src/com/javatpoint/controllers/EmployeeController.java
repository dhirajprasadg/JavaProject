...
import com.javatpoint.daoImpl.EmployeeDaoImpl;
...
public class EmployeeController {
	...
	// Value will be injected from xml either through setter or constructer DI
	@Autowired
	 ...
	 */
	@RequestMapping(value = "/saveing", method = RequestMethod.POST)
