...
public class EmpController {  
    ...
    public ModelAndView showform(){  
        ...
        return new ModelAndView("empformpage","command",new Emp());  
    }  
    ...
    public ModelAndView save(@ModelAttribute("emp") Emp emp){  
        ...
        return new ModelAndView("redirect:/viewemppage");//will redirect to viewemp request mapping  
    }  
      
    @RequestMapping("/viewemppage")  
    public ModelAndView viewemp(){  
        ...
        return new ModelAndView("viewemppage","list",list);  
    }  
}  